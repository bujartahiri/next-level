  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#EDEDED] font-sans py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-5xl font-black tracking-normal text-white mb-2">Impressum</h1>
        ...
        <div className="space-y-6 text-base text-neutral-300 leading-relaxed bg-[#0a0a0a] p-8 sm:p-10 rounded-2xl border border-white/10">
          <div>
            <h2 className="text-lg sm:text-xl font-bold tracking-normal text-white mb-2">Betreiber der Website</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-bold tracking-normal text-white mb-2">Kontakt</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-bold tracking-normal text-white mb-2">Umsatzsteuer-ID</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-bold tracking-normal text-white mb-2">EU-Streitschlichtung</h2>
            <p>
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-bold tracking-normal text-white mb-2">Haftung für Inhalte und Links</h2>
